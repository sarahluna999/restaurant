...
?>
<?php  $connection = mysqli_connect(DB_SERVER, DB_USERNAME, DB_PASSWORD);
			...
			<div class="row" style="flex-wrap: nowrap;">
				<div class="col-md-6 home-left-section">
					<div style="padding: 100px 0px; color: white;">
						...
						<hr>
						<p>
							Vous pouvez reserver votre table ou votre plat preféré.  
						</p>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="footer_widget">
                        ...
                        <p>
                            Notre restaurant est le meilleur, proposer des menus et des plats savoureux. Vous pouvez reservez.
                        </p>
